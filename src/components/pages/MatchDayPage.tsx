        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-4">
            ...
            <p className="text-sm sm:text-base text-slate-300 font-sans max-w-xl leading-relaxed">
              Match Day rounds, live scoring, surprise problem twists, and milestone submissions will go live once shortlisted squads are officially announced on <strong>10 September 2026</strong>.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs font-mono text-slate-300 pt-2">
              <div className="flex items-center gap-1.5">
                ...
                <span>Shortlist Announcement: 10 September 2026</span>
              </div>
              <div className="flex items-center gap-1.5">
